...
export default function SearchPage({ params } : { params: any }){
    // Next.js may pass `params` as a Promise; unwrap with React.use(params) when available.
    // React.use is recommended by Next.js for this migration; provide a safe runtime fallback.
