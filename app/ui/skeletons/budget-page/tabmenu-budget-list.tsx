                ...
                <div className="w-full mx-auto">
                    <div className="relative border-b border-gray-300">
                        <div className="flex justify-between">
                            <div className="mr-2 flex-1 h-[37px] w-[125px] rounded-md bg-gray-200 text-sm font-medium" />
                            <div className="mr-2 flex-1 h-[37px] w-[125px] rounded-md bg-gray-200 text-sm font-medium" />
                            <div className="flex-1 h-[37px] w-[125px] rounded-md bg-gray-200 text-sm font-medium" />
                        </div>
                    </div>
                    <div className="mt-4">
